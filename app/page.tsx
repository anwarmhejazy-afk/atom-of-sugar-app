...
const products: Product[] = [
  {
    ...
    description: {
      ...
      ar: "ميني مبروشة بنكهات مختلفة، مثالية للتقديم والعزومات.",
    },
    note: {
    ...
    options: [
      {
        id: "24-pieces",
        labelEn: "24 Pieces — 45 AED",
        labelAr: "24 قطعة — 45 درهم",
        price: 45,
      },
      {
        id: "32-pieces",
        labelEn: "32 Pieces — 65 AED",
        labelAr: "32 قطعة — 65 درهم",
        price: 65,
      },
    ],
  ...
  },
  {
    ...
    description: {
      ...
      ar: "متوفرة بحشوة مكسرات أو قشطة أو بطريقة القطايف العصافيري.",
    },
    note: {
